...
dataset = torch.load('./graph/processed/litter_graph.pt')
...
tw_data = pd.read_csv('../Baseline/Baseline_data.csv')
...
class HAN(nn.Module):
    def __init__(self, in_channels: Union[int, Dict[str, int]],
        ...
        self.han_conv = HANConv(in_channels, hidden_channels, heads=heads,
                                dropout=0.6, metadata=dataset[0][0][2].metadata())
...
class Spatial_Net1(torch.nn.Module):
    def __init__(self, num_node_features1, num_node_features2):
        ...
        self.gat1 = GATv2Conv(num_node_features1, out_channels=1, heads=20, dropout=0.6)
        self.gat2 = GATv2Conv(num_node_features2, out_channels=1, heads=1, dropout=0.6)
...
class Model(torch.nn.Module):
    def __init__(self, num_node_features_cluster1_1, num_node_features_cluster1_2,
        ...
        # self.t_fcn = nn.Linear(14, 1)
        self.fcn = nn.Linear(100, 1)
