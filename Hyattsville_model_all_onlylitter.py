...
tw_data = pd.read_csv('./Hyattsville_baseline/Hyattsville_onlylitter.csv')
...
class Spatial_Net1(torch.nn.Module):
    def __init__(self, num_node_features1, num_node_features2):
        ...
        self.gat1 = GATv2Conv(num_node_features1, out_channels=100, heads=2)
        self.gat2 = GATv2Conv(num_node_features2, out_channels=1, heads=2)
        self.han = HAN(-1, out_channels=200)
        self.re = nn.ReLU()
        self.fcn = nn.Linear(181, 5)
