...
#     for i in range(210):
#         for j in range(1, 5):
#             poi = gpd.read_file('POI_all/points.shp')
...
#             poi_litter_edge.to_csv('./poi_litter_edge/poi_litter_day{0}_cluster{1}.csv'.format(i, j))
#     print('over')
# test
# 路径
poi_litter_edge_path = './poi_litter_edge/poi_litter_day200_cluster1.csv'
litter_path = './litter_days/day200_litter1.csv'
litter_edge_path = './litter_days_edge/day200_litter1.csv'
litter_ad_path = './litter_days_df/litter_ad.csv'
...
print(data_poi_litter)
print(data_poi_litter.num_nodes)
print(data_poi_litter.num_edges)
