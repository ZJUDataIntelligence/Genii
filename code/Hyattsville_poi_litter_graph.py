...
#             litter_df = pd.read_csv('./Hyattsville_litter_days_df/day{0}_litter{1}.csv'.format(i, j))
...
#             poi_litter_edge.to_csv('./Hyattsville_poi_litter_edge/poi_litter_day{0}_cluster{1}.csv'.format(i, j))
#     print('over')
# test
# 路径
poi_litter_edge_path = './Hyattsville_poi_litter_edge/poi_litter_day0_cluster1.csv'
litter_path = './Hyattsville_litter_days_df/day0_litter1.csv'
litter_edge_path = './Hyattsville_litter_days_edge/day0_litter1.csv'
litter_ad_path = './Hyattsville_litter_days_df/litter_ad.csv'
