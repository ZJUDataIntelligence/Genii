...
#     litter_ad = pd.read_csv('./Krommenie_litter_days/day79_litter1.csv')
#     litter_ad_df = litter_ad[['id', 'lat', 'lon', 'total_litter']]
#     litter_ad_df.to_csv('./Krommenie_litter_days_df/litter_ad.csv')
#     for i in range(181):
#         for j in range(1, 5):
#             litter = pd.read_csv('./Krommenie_litter_days/day{0}_litter{1}.csv'.format(i, j))
#             litter_df = litter[['id', 'lat', 'lon', 'total_litter']]
#             litter_edge = litter_distance(0.05, litter_df, litter_ad, 85)
#             litter_df.to_csv('./Krommenie_litter_days_df/day{0}_litter{1}.csv'.format(i, j))
#             litter_edge.to_csv('./Krommenie_litter_days_edge/day{0}_litter{1}.csv'.format(i, j))
#
#     print('over')
# test
for i in range(181):
